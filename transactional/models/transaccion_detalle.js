let transaccion_detalle = {
	...
	id_documento: {type: "BIGINT", name: "id_documento", foreignKey: true, ref: "tipo_transaccion_documento", refField: "id_documento", commentForeign: "id_documento_fk", modelType: "Number"},
